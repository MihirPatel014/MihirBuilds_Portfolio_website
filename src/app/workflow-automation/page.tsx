        ...
        <div className="bg-[#F8FAFC]">
            ...
            <section className="py-12 md:py-20 bg-white">
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    ...
                    >
                        <h2 className="text-4xl md:text-5xl font-bold text-[#0F172A] mb-4">Powerful Workflow Features</h2>
                        <p className="text-xl text-gray-600 max-w-3xl mx-auto">Build, automate, and optimize workflows with our comprehensive automation platform</p>
                    </motion.div>
            ...
            <section className="py-12 md:py-20 bg-gradient-to-b from-gray-50 to-white">
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    <motion.div
                        ...
                        className="text-center mb-16"
                    >
                        <h2 className="text-4xl md:text-5xl font-bold text-[#0F172A] mb-4">Popular Workflow Examples</h2>
                        <p className="text-xl text-gray-600">Get inspired by these common automation workflows</p>
                    </motion.div>
