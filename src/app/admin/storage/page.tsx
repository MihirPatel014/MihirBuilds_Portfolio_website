...
import { checkAdminAuth, verifyAdminPassword, logoutAdmin } from "@/app/actions/storage";
import { Button } from "@/components/Button";
import { Upload, AlertTriangle, Plus, Info, Tag, FileText, ArrowRight, Search, LayoutGrid, ListIcon, ExternalLink, Trash2, Clock, Lock } from "lucide-react";
...
export default function AdminStorage() {
  ...
  const adminToken = () => {
    return process.env.NEXT_PUBLIC_ADMIN_STORAGE_TOKEN || 'admin123';
  };
