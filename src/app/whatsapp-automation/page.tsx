        ...
        <div className="bg-[#F8FAFC]">
            ...
            <section className="py-20 bg-white">
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    ...
                    >
                        <h2 className="text-4xl md:text-5xl font-bold text-[#0F172A] mb-4">Powerful WhatsApp Features</h2>
                        <p className="text-xl text-gray-600 max-w-3xl mx-auto">Everything you need to automate customer conversations and scale your business</p>
                    </motion.div>
            ...
            <section className="py-12 md:py-20 bg-gradient-to-b from-gray-50 to-white">
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    <motion.div
                        ...
                        className="text-center mb-16"
                    >
                        <h2 className="text-4xl md:text-5xl font-bold text-[#0F172A] mb-4">Perfect For Every Business</h2>
                    </motion.div>
            ...
            <section className="py-20 bg-white">
                <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
                    <motion.div
                        ...
                        viewport={{ once: true }}
                    >
                        <h2 className="text-4xl md:text-5xl font-bold text-[#0F172A] mb-6">Flexible Plans for Every Business Size</h2>
                        <p className="text-xl text-gray-600 mb-8">From startups to enterprises, we have a plan that fits your needs and budget.</p>
                        <Link href="/contact">
